...
class SC(nn.Module):
    ...
    def __init__(self,
        ...
        self.separable_conv2d_1x3 = nn.Conv2d(in_channels=in_channels,
                                              out_channels=out_channels,
                                              kernel_size=kernel_sizes[0],
                                              stride=stride_sizes[0],
                                              padding=padding_sizes[0])
        self.separable_conv2d_3x1 = nn.Conv2d(in_channels=out_channels,
                                              out_channels=out_channels,
        ...
        self.separable_conv2d = nn.Sequential(self.separable_conv2d_1x3, nn.ReLU(), self.BN_1x3,
                                              self.separable_conv2d_3x1, nn.ReLU(), self.BN_3x1)
...
class Encoder(nn.Module):
    ...
    def __init__(self,
                 shapes=[(1, 256, 32), (d, 128, 16), (d, 64, 8), (2 * d, 32, 4), (2 * d, 16, 2), (4 * d, 8, 1),
                         (4 * d, 4, 1), (h, 2, 1)],
