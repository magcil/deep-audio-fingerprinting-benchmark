...
if __name__ == '__main__':
    ...
    # Initialize logger
    logging.basicConfig(filename=os.path.join(project_path, 'logs', args['experiment_name'] + '_recording_test.log'),
                        encoding='utf-8',
                        level=logging.INFO,
    ...
    # Log all predictions
    table = PrettyTable()
    table.field_names=["Index", "True", "Pred"]
    for i, (yt, yp) in enumerate(zip(y_true, y_pred)):
        table.add_row([i, yt, yp])
